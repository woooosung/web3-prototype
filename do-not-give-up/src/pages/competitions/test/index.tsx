...
const Upload = () => {
  ...
  useEffect(() => {
    ...
    return (
      <div>
        <Typography align='center' variant='h4' sx={{ fontWeight: 700, marginBottom: 1.5 }}>🔥Competition🔥</Typography><br/>
      ...
      <Box sx={{ mb: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <form onSubmit={handleSubmit}>
          ...
          <br /><br /><br />
          <Button  variant='contained' color='primary' onClick={submitBtn} type='submit'>Submit</Button>
        </form>
        </Box>
      </div>
    );
